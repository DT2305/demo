...
<div class="page-wrapper bg-blue p-t-180 p-b-100 font-robo">
    <div class="wrapper wrapper--w960">
        <div class="card card-2">
            ...
            <div class="card-body">
                <h2 class="title">Thông tin đăng ký ứng tuyển</h2>
                <form method="POST">
                    <!-- Họ và tên -->
                    ...
                    <div class="input-group">
                        <input class="input--style-2" type="number" placeholder="Mã số chứng minh nhân dân" name="">
                    </div>
                    <!-- Số điện thoại -->
                    <div class="input-group">
                    ...
                    <!-- Tên trường THPT -->
                    <div class="input-group">
                        <input class="input--style-2" type="text" placeholder="Tên Trường THPT" name="">
                    </div>
                    <!-- Địa chỉ thường trú -->
